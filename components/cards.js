...
export function Card(props){
  return (
    <Link href={props.link}>
      <div className="flex flex-col border-2 m-3">
        <div className="group w-full h-80">
        <img className="transition-all ease-in-out duration-200 hover-none:brightness-[0.5] hover-hover:group-hover:brightness-[0.1]  object-cover w-full h-full " src={props.img} alt={props.alt} />
