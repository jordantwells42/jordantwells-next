  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex flex-col rounded m-3"
      >
        <div className="group w-full h-80">
          <img
            className="rounded-xl transition-all ease-in-out duration-200 brightness-50 hover-hover:group-hover:brightness-[0.1]  object-cover w-full h-full "
            src={props.img}
            alt={props.alt}
          />
