  ...
  return (
    <Link href={props.link}>
      <div className="flex flex-col border-2 my-3">
        ...
        <img className="transition-all ease-in-out duration-200 hover-none:brightness-[0.65] hover-hover:group-hover:brightness-[0.1]  object-cover w-full h-full " src={props.img} alt={props.alt} />
