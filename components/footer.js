...
export default function Footer() {
  ...
  return (
    <div className="overflow-hidden pb-10 flex flex-col items-center justify-center">
      <div onMouseEnter={changeToggle} className={toggleStyle.translateyinv + " animate-bounce transition-transform ease-out duration-200 mt-10 flex flex-col border-2 hover:cursor-pointer rounded-full bg-blue-400 w-10 h-10 z-50"}>
