...
export default function Navbar() {
  ...
  return (
    <div className="transition-all ease-in-out duration-1000 rounded-full w-20 flex flex-col items-center justify-center fixed top-5 right-5 z-50">
      <div  onClick={changeToggle} className="flex flex-col justify-center text-center border-2 hover:cursor-pointer  rounded-full bg-blue-400 w-10 h-10 z-50">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-1/2 w-1/2 text-white flex flex-row justify-center items-center" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
